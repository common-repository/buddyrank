	...
	*************************************************/
	function aheadzen_admin_settings_page()
	{
		...
		if($_POST)
		{
			...
			update_option('azbr_lasttime_hrs',$_POST['azbr_lasttime_hrs']);
			update_option('azbr_lasttime_days',$_POST['azbr_lasttime_days']);
		...
		<form method="post" action="<?php echo admin_url();?>options-general.php?page=azbpactivity">
			<table class="form-table">
				...
				<tr valign="top">
					...
					<label for="azbr_lasttime_hrs">
					<p><?php _e('Latest Activity Time duration (default is : 24 hours)','aheadzen');?></p>
					<p><input style="width:60px;" type="text" name="azbr_lasttime_hrs" placeholder="Hours" value="<?php echo get_option('azbr_lasttime_hrs');?>">
					<?php _e('hours ','aheadzen');?>
					&nbsp;&nbsp;&nbsp;
					<b><?php _e(' OR ','aheadzen');?></b>
					&nbsp;&nbsp;&nbsp;
					<input style="width:50px;" type="text" name="azbr_lasttime_days" placeholder="Days" value="<?php echo get_option('azbr_lasttime_days');?>">
					<?php _e('days (first priority)','aheadzen');?>
					</p>
					</label>					
					</td>
				</tr>
				<tr valign="top">
					...
					<p><?php _e('Latest Activity (default is : 100)','aheadzen');?></p>
